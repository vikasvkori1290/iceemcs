...
export default function TopHeader() {
  return (
    <div className="w-full bg-ocean-deep text-slate-200 py-1.5 px-4 sm:px-8 border-b border-white/10 text-xs select-none">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
        {/* Left Side: Event Date Badge & Location */}
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-ocean-blue/30 border border-ocean-cyan/40 text-ocean-sky font-semibold tracking-wide text-[11px]">
            <Calendar className="w-3 h-3 text-ocean-cyan shrink-0" />
          ...
          <span className="hidden md:inline-flex items-center gap-1 text-slate-300 text-[11px]">
            <MapPin className="w-3 h-3 text-ocean-sky" />
        ...
        <div className="flex items-center gap-4 sm:gap-6 text-[11px] sm:text-xs">
          ...
          <a
            ...
            className="flex items-center gap-1.5 hover:text-ocean-sky transition-colors text-slate-200"
            title="Send email to conference secretariat"
          >
            <Mail className="w-3.5 h-3.5 text-ocean-cyan shrink-0" />
          ...
          >
            <Phone className="w-3.5 h-3.5 text-ocean-cyan shrink-0" />
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-white/10">
            ...
            <a
              ...
              className="w-5 h-5 rounded bg-white/10 hover:bg-ocean-blue text-slate-200 hover:text-white flex items-center justify-center transition-all duration-200"
