...
export default function Footer({ setActiveSection }) {
  ...
  return (
    <footer className="bg-ocean-deep text-slate-300 border-t border-white/10 select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-ocean-blue/30 border border-ocean-cyan/40 text-ocean-cyan flex items-center justify-center">
              ...
              <div>
                ...
                <span className="text-[11px] font-semibold text-ocean-sky uppercase tracking-wider">
            ...
            <div className="pt-2 flex items-center gap-3">
              <span className="px-2.5 py-1 rounded bg-white/10 text-ocean-sky text-xs font-semibold">
                IEEE Format
              </span>
              <span className="px-2.5 py-1 rounded bg-white/10 text-ocean-sky text-xs font-semibold">
                CMT Submission
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-white font-bold text-sm sm:text-base uppercase tracking-wider border-b border-white/10 pb-2">
              Quick Navigation
            </h4>
              ...
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className="flex items-center gap-1.5 text-slate-300 hover:text-ocean-sky transition-colors group py-0.5 cursor-pointer"
                  >
                    <ChevronRight className="w-3.5 h-3.5 text-ocean-cyan group-hover:translate-x-1 transition-transform" />
                    <span>{link.name}</span>
                  </a>
                </li>
              ))}
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-300">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-ocean-cyan shrink-0 mt-0.5" />
              ...
              <div className="pt-1">
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs text-ocean-sky hover:text-ocean-ice font-semibold"
                >
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-300">
              <div className="flex items-start gap-2.5">
                <Mail className="w-4 h-4 text-ocean-cyan shrink-0 mt-0.5" />
                <div>
                  <span className="text-[11px] text-ocean-sky/80 uppercase block font-semibold">
                    Editorial Inquiries
                  </span>
                  <a
                    href="mailto:editor@cmr.edu.in"
                    className="text-white hover:text-ocean-sky transition-colors font-medium"
                  >
                    editor@cmr.edu.in
                  </a>
                </div>
              ...
              <div className="flex items-start gap-2.5">
                <Phone className="w-4 h-4 text-ocean-cyan shrink-0 mt-0.5" />
                <div>
                  <span className="text-[11px] text-ocean-sky/80 uppercase block font-semibold">
                  ...
                  <a
                    ...
                    className="text-white hover:text-ocean-sky transition-colors font-medium block"
                  >
      ...
      <div className="border-t border-white/10 bg-[#020336] py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <p className="text-center sm:text-left">
            &copy; {new Date().getFullYear()} <strong className="text-white font-bold">ICEEMCS</strong>. All Rights Reserved. Hosted by <span className="text-slate-300">CMR University, Bengaluru</span>.
          </p>

          <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400">
            <span className="hover:text-ocean-sky transition-colors cursor-pointer">
              Privacy Policy
            </span>
            <span>•</span>
            <span className="hover:text-ocean-sky transition-colors cursor-pointer">
