...
export default function TopicsSection({ onNavigate }) {
  ...
  const tracksData = [
    {
      ...
      shortTitle: 'CS & AI',
      icon: Cpu,
      badgeColor: 'bg-ocean-ice text-ocean-deep border-ocean-sky/60',
      accentBorder: 'border-ocean-blue',
      description:
    ...
    },
    {
      ...
      icon: Zap,
      badgeColor: 'bg-ocean-ice text-ocean-blue border-ocean-cyan/50',
      accentBorder: 'border-ocean-cyan',
      description:
    ...
    },
    {
      ...
      icon: Briefcase,
      badgeColor: 'bg-ocean-ice text-ocean-deep border-ocean-sky/40',
      accentBorder: 'border-ocean-sky',
      description:
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* 1. Top Header Banner with Circuit / Tech Overlay */}
      <div className="relative w-full h-48 sm:h-56 md:h-64 overflow-hidden bg-ocean-deep">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10 pb-6">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-ocean-blue/30 text-ocean-sky font-bold text-xs uppercase tracking-widest border border-ocean-cyan/40 mb-2">
            <Sparkles className="w-3.5 h-3.5 text-ocean-cyan" /> Call for Papers & Tracks
          </span>
      ...
      <section className="pt-12 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-sm mb-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h2 className="text-base sm:text-lg font-bold text-ocean-deep">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-ocean-deep hover:bg-[#021f45] text-white text-xs sm:text-sm font-bold shadow-sm transition-all duration-200 hover:scale-[1.02] cursor-pointer"
                title="Download Call for Papers Brochure"
              >
                <FileText className="w-4 h-4 text-ocean-cyan" />
                <span>CFP Brochure</span>
                <span className="text-[11px] font-medium text-ocean-sky bg-white/10 px-2 py-0.5 rounded-md">
                  PDF • 1.4 MB
                </span>
              ...
              <button
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-linear-to-r from-ocean-blue to-ocean-cyan hover:from-ocean-deep hover:to-ocean-blue text-white text-xs sm:text-sm font-bold shadow-sm transition-all duration-200 hover:scale-[1.02] cursor-pointer"
                title="Download Official Paper Template"
              >
                <Download className="w-4 h-4 text-white" />
                <span>Paper Template</span>
                <span className="text-[11px] font-semibold text-ocean-deep bg-white/40 px-2 py-0.5 rounded-md">
                  .DOCX / LaTeX • 2.8 MB
                </span>
              </button>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-slate-50 hover:bg-slate-100/70 focus:bg-white border border-slate-200 rounded-xl text-xs sm:text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-ocean-cyan/30 focus:border-ocean-blue transition-colors"
              />
              {searchQuery && (
                <button
            ...
            {/* Results Count Badge */}
            <div className="flex items-center gap-2 self-end lg:self-center text-xs font-semibold text-ocean-blue bg-ocean-ice/50 px-3 py-1.5 rounded-lg shrink-0 border border-ocean-sky/40">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100">
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                activeTab === 'all'
                  ...
                  : 'bg-slate-100 text-slate-600 hover:bg-ocean-ice/50 hover:text-ocean-blue'
              }`}
            >
              All Tracks
            </button>
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                activeTab === 'cs'
                  ? 'bg-ocean-blue text-white shadow-xs'
                  : 'bg-slate-100 text-slate-600 hover:bg-ocean-ice/50 hover:text-ocean-blue'
              }`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                activeTab === 'ee'
                  ? 'bg-ocean-cyan text-ocean-deep shadow-xs font-black'
                  : 'bg-slate-100 text-slate-600 hover:bg-ocean-ice/50 hover:text-ocean-blue'
              }`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                activeTab === 'mgmt'
                  ? 'bg-ocean-sky text-ocean-deep shadow-xs font-bold'
                  : 'bg-slate-100 text-slate-600 hover:bg-ocean-ice/50 hover:text-ocean-blue'
              }`}
            >
        ...
        {filteredTracks.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 shadow-xs max-w-md mx-auto">
            <div className="w-12 h-12 bg-ocean-ice rounded-full flex items-center justify-center mx-auto text-ocean-blue mb-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-ocean-deep text-white text-xs font-bold rounded-lg hover:bg-ocean-blue transition-colors cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
                ...
                >
                  ...
                  <div className="bg-slate-50/80 border-b border-slate-100 p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start sm:items-center gap-3.5">
                      <div className="w-11 h-11 rounded-xl bg-ocean-deep text-ocean-cyan flex items-center justify-center shrink-0 shadow-xs">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg sm:text-xl font-extrabold text-ocean-deep mt-0.5">
                          {track.title}
                        </h3>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-ocean-deep hover:text-white bg-white hover:bg-ocean-blue px-3.5 py-2 rounded-lg border border-slate-200 hover:border-ocean-blue transition-all cursor-pointer self-start sm:self-center shadow-xs"
                    >
                  ...
                  <div className="p-5 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-3.5">
                    {track.topics.map((topic, idx) => (
                      <div
                        key={idx}
                        className="group flex items-start gap-3 p-3 rounded-xl bg-slate-50/50 hover:bg-ocean-ice/40 border border-slate-100 hover:border-ocean-sky/60 transition-all duration-200"
                      >
                        <span className="w-6 h-6 rounded-md bg-white text-slate-600 group-hover:bg-ocean-deep group-hover:text-ocean-cyan text-[11px] font-bold flex items-center justify-center shrink-0 border border-slate-200 shadow-xs transition-colors">
                          {idx + 1}
                        </span>
                        <p className="text-xs sm:text-sm text-slate-700 group-hover:text-ocean-deep font-medium leading-snug">
                          {topic}
                        </p>
                      </div>
                    ))}
        ...
        <div className="mt-14 bg-linear-to-r from-ocean-deep via-[#021f45] to-ocean-blue rounded-2xl p-6 sm:p-10 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl border border-ocean-blue/30">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-200 max-w-xl">
              ...
              Deadline: <strong className="text-ocean-cyan font-bold">February 05, 2027</strong>.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              onClick={() => onNavigate?.('SUBMISSION')}
              className="px-6 py-3 bg-linear-to-r from-ocean-cyan to-ocean-sky hover:from-ocean-blue hover:to-ocean-cyan text-ocean-deep hover:text-white font-black text-xs sm:text-sm rounded-xl transition-transform hover:scale-105 shadow-md cursor-pointer"
            >
